...
<div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-20'>
    ...
    <div className='font-bold'>
    Container-as-a Service (CaaS) Security.</div>
    <div className='font-bold'>
    Coding Pipeline and CI/CD Security</div>
    <div className='font-bold'>
    
        Infrastructure-as-a-Service (IaaS) Security</div>
    <div className='font-bold'>
    
        DevSecOps leveraging cloud-native tools</div>
    <div className='font-bold'>
  
        Platform-as-a-Service (PaaS) Security,</div>
