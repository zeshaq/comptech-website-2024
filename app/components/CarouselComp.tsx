...
<div data-hs-carousel='{
  ...
  <div className="hs-carousel relative overflow-hidden w-full min-h-[550px] bg-white ">
    <div className="hs-carousel-body absolute top-0 bottom-0 start-0 flex 
    flex-nowrap transition-transform duration-700 opacity-0">
      ...
      <div className="hs-carousel-slide bg-cover" style={{backgroundImage: 'url("/images/bg2.png")'}}>
      ...
      <div className="text-center py-40 px-4 sm:px-6 lg:px-8">
          ...
          <p className="mt-3  font-black text-white">
          We are passionate about the value creation of our customers. We understand their culture and are on the spot – almost 24h per day.
            </p>
          <div className="mt-5 flex flex-col justify-center items-center gap-2 sm:flex-row sm:gap-3">
            <a className="w-full sm:w-auto py-3 px-4 inline-flex 
            justify-center items-center gap-x-2 text-sm font-semibold 
      ...
      <div className="hs-carousel-slide bg-cover" style={{backgroundImage: 'url("/images/bg3.png")'}}>
