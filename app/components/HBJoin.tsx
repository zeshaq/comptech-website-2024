...
const HBJoin = () => {
  return (
    ...
    <div className="flex flex-row">
        ...
        <div className="basis-4/12 relative bg-cover bg-center " style={{backgroundImage: 'url("/images/bg1.png")'}}>
        ...
        <div className="basis-8/12 bg-sky-950 text-slate-100">
            ...
            BECOME A PART OF COMPTECH
                ...
                <p className='px-24 pb-24 text-3xl text-center'>
                Create fresh ideas and shape the digital transformation of our enterprise
                 customers sustainably surrounded by inspiring colleagues. Sounds like a match to you?
             
                 <a href="/join_us" className='block'>
                          <button type="button" className="py-5 px-7 mt-12 text-2xl
