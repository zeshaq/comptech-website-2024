  ...
  return (
    <div className='p-12'>
        ...
        <div className='flex flex-row'>
           ...
           <h1 className='text-4xl font-black'> We Understand the
Nitty-Gritty!</h1>

<p className='text-2xl font-extralight'>Gain leverage with our proven expertise & industry exposure. Working with 100+ clients, we know the criticalities, compliances & the importance of getting things right in the first go.
...
Customers demand highly available & compliant systems to efficiently handle transactions & payment requests 24/7. →
                    ...
                    <div>
                        <h1 className=' text-4xl font-black pb-6'> Travel & Hospitality</h1>
                        <p className='text-2xl font-extralight'>
...
Delight your customers with seamless operation & instant updates using cost-effective, flexible, and scalable system.
                    ...
                    <div>
                        <h1 className=' text-4xl font-black pb-6'>     Technology, SaaS & Internet</h1>
                        <p className='text-2xl font-extralight'>
...
Keep up with the rising customer expectations and integrate more technologies while reaching heights of a safer and sustainable future. →
                    ...
                    <div>
                        <h1 className=' text-4xl font-black pb-6'>Energy Sector</h1>
                        <p className='text-2xl font-extralight'>
